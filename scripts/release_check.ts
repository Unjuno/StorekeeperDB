...
if (!releaseCheck.includes("experiment:required-field-evolution:check")) fail("release:check must include experiment:required-field-evolution:check");
...
const requiredScripts = [
  ...
  "experiment:required-field-evolution",
...
const publicDocs = [
  ...
  "docs/REQUIRED_FIELD_VALUE_EVOLUTION_EXPERIMENT.md",
  "docs/MANUAL.md",
...
const requiredPublicText: Array<[string, string]> = [
  ...
  ["docs/STATE_MERGE_BOUNDARY_EXPERIMENT.md", "BOUNDARY CONFIRMED in CI #205"],
  ["docs/STATE_MERGE_BOUNDARY_EXPERIMENT.md", "BOUNDARY_CONFIRMED_MERGE_REQUIRES_EXPLICIT_CONFLICT_AWARE_MIGRATION"],
  ...
  ["docs/REQUIRED_FIELD_VALUE_EVOLUTION_EXPERIMENT.md", "BOUNDARY CONFIRMED in CI #224"],
  ["docs/REQUIRED_FIELD_VALUE_EVOLUTION_EXPERIMENT.md", "BOUNDARY_CONFIRMED_REQUIRED_FIELD_REQUIRES_EXPLICIT_BACKFILL_POLICY"],
  ["docs/REQUIRED_FIELD_VALUE_EVOLUTION_EXPERIMENT.md", "fresh V2 initializer are not a migration mechanism"],
  ["docs/REQUIRED_FIELD_VALUE_EVOLUTION_EXPERIMENT.md", "exactPhysicalRollback = true"],
  ["docs/REQUIRED_FIELD_VALUE_EVOLUTION_EXPERIMENT.md", "existing `queue` projection remained intact"],
  ["docs/REQUIRED_FIELD_VALUE_EVOLUTION_EXPERIMENT.md", "No public migration API is authorized by this result."],
  ...
  ["docs/NEXT_WORK.md", "BOUNDARY_CONFIRMED_REQUIRED_FIELD_REQUIRES_EXPLICIT_BACKFILL_POLICY"],
  ["docs/NEXT_WORK.md", "Evaluate migration idempotency and crash/retry markers"],
...
console.log(JSON.stringify({
  ...
  hasRequiredFieldEvolutionExperiment: true,
